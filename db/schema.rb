...
ActiveRecord::Schema.define(version: 2021_08_24_165016) do
  ...
  create_table "commentlikes", force: :cascade do |t|
    ...
    t.index ["comliked_id"], name: "index_commentlikes_on_comliked_id"
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.string "talkroom"
    t.index ["talkroom"], name: "index_messages_on_talkroom"
